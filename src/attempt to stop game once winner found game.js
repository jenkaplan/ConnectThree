...
class Game {
  ...
  addPlayerCol1(currentPlayer, c1, winnerFound) {
  ...
  addPlayerCol2(currentPlayer, c2, winnerFound) {
    // if (this.winnerFound === false) {
      if (this.currentPlayer === 'putin') {
  ...
  addPlayerCol3(currentPlayer, c3, winnerFound) {
    // if (this.winnerFound === false) {
      if (this.currentPlayer === 'putin') {
    ...
    // }
  // }
  addPlayerCol4(currentPlayer, c4, winnerFound) {
    // if (this.winnerFound === false) {
      if (this.currentPlayer === 'putin') {
